    ...
    return(
        ...
        <div>
            ...
            <div className={Zipstyles.zipCode__group}>
                <input type="text" id="zipcode" value={zipcode} readOnly placeholder="01234" onChange={props.onChange} />
                <Button variant='FormBtn' type='button' onClick={props.onClick}>우편번호 검색</Button>
            </div>
        </div>
        <input type="text" id="address" placeholder={props.placeholder} value={address} readOnly onChange={props.onChange}/>
        {props.placeholder_2 && <input type="text" id="addressDetail" placeholder={props.placeholder_2} value={addressDetail} onChange={props.onChange}/>}
      </div>
    );
}