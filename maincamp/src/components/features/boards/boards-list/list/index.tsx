...
export default function BoardsList () {
    ...
    const {changeCurrentPage, fetchBoards, fetchBoardsCount, onClickBoardsNew, flex, textAlign, pageNum, currentPage, loading } = useBoardsList();
        ...
        <div className={styles.BoardsList}>
            ...
            <div className={styles.BoardsListContainer}>
                ...
                >
                    ...
                    <Pagination BoardsCount={fetchBoardsCount} currentPage={currentPage} changeCurrentPage={changeCurrentPage} />
                </DataList>
            </div>
        </div>
    )
