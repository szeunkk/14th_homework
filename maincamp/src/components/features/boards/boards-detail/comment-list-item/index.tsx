...
export default function CommentListItem({el}:{el:IComment}){
    ...
    return(
        ...
        <Fragment key={el._id}>
            <div className={styles.CommentRow}>
                ...
                <div className={styles.CommentDate}>{formatInTimeZone(new Date(el.createdAt), 'Asia/Seoul', 'yyyy.MM.dd')}</div>
            </div>
            <hr/>
        </Fragment>
        )
