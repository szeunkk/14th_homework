...
export default withAuth(function CommentListItem({
  el,
  isAuth,
}: {
  el: IComment;
          ...
          <div>
            ...
            <div className={styles.CommentRated}>
              <StarTwoTone
                ...
                twoToneColor={1 <= el.rating ? "#FADA67" : "#C7C7C7"}
              />
              <StarTwoTone
                style={{ fontSize: "1.25rem" }}
                twoToneColor={2 <= el.rating ? "#FADA67" : "#C7C7C7"}
              />
              <StarTwoTone
                style={{ fontSize: "1.25rem" }}
                twoToneColor={3 <= el.rating ? "#FADA67" : "#C7C7C7"}
              />
              <StarTwoTone
                style={{ fontSize: "1.25rem" }}
                twoToneColor={4 <= el.rating ? "#FADA67" : "#C7C7C7"}
              />
              <StarTwoTone
                style={{ fontSize: "1.25rem" }}
                twoToneColor={5 <= el.rating ? "#FADA67" : "#C7C7C7"}
              />
            </div>
          </div>
