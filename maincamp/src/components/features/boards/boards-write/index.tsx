    ...
    return(
        <div className={styles.Formfield}>
            ...
            <div className={styles.postForm__writer__group}>
                <Inputfield type='text' label='작성자' required placeholder='작성자 명을 입력해 주세요.' isEdit={isEdit} onChange={onChangeWriter}></Inputfield>
            ...
            <div className={styles.postForm__button__group}>
                ...
                <Button type="submit" variant='FormBtn' disabled={isEdit? false :isValid} onClick={onClickSubmit}>{isEdit? "수정" : "등록"}하기</Button>
            </div>
        </div>
    );
}